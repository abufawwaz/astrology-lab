...
public class RelocationRecord extends Event {
  ...
  public static int getLocationOfPerson(int person, long timestamp) {
    ...
    String sqlRelocation = "SELECT location, time as event_time FROM " + TABLENAME + " WHERE " + TABLENAME + ".subject_id=" + person + " AND " + TABLENAME + ".time < '" + sqltimestamp + "' ORDER BY time DESC";
