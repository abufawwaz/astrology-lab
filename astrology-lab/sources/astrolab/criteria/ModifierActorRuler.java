...
public class ModifierActorRuler implements Modifier {
  ...
  public Criterion getModifiedCriterion(Criterion criterion, SpacetimeEvent periodStart, SpacetimeEvent periodEnd) {
    int sign = (int) (ActivePoint.getActivePoint(criterion.getActor(), periodStart).getPosition() / 30);
  ...
  public String actorToString(Criterion criterion, String actor) {
    return "(" + Text.getText("ruler") + " " + Text.getText("of") + " " + actor + ")";
  }
