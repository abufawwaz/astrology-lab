...
//          ch = Integer.parseInt(code + (char) bytes[i + 4] + "" + (char) bytes[i + 5], 16) - Integer.parseInt("D0B0", 16) + ((int) '�'); 
            ch = Integer.parseInt(code + (char) bytes[i + 4] + "" + (char) bytes[i + 5], 16) - Integer.parseInt("D0B0", 16) + ((int) 'а'); // a
          i += 5;
...
//            ch = Integer.parseInt(code + (char) bytes[i + 4] + "" + (char) bytes[i + 5], 16) - Integer.parseInt("D180", 16) + ((int) '�'); 
            ch = Integer.parseInt(code + (char) bytes[i + 4] + "" + (char) bytes[i + 5], 16) - Integer.parseInt("D180", 16) + ((int) 'р'); // r
          i += 5;
        } else {
